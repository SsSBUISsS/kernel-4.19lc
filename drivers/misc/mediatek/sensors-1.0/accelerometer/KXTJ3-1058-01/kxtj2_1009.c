...
static struct proc_dir_entry *kxtj2_config_proc;
...
static ssize_t kxtj2_config_write_proc(struct file *file, const char *buffer, size_t count,loff_t *ppos)
{
        return 0;
}
static ssize_t kxtj2_config_read_proc(struct file *file, char *buffer, size_t count, loff_t *ppos)
{
    int err = -1 ;
    char name[20] = "KXTJ2_1058";
...
static const struct file_operations kxtj2_upgrade_proc_fops = {
	.write = kxtj2_config_write_proc,
	.read = kxtj2_config_read_proc,
};
/*----------------------------------------------------------------------------*/
       ...
       unsigned long arg)
{
	...
	case COMPAT_GSENSOR_IOCTL_INIT:
		...
		if (err){
			GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_INIT  failed.");
			return err;
		}
		break;
	...
	case COMPAT_GSENSOR_IOCTL_READ_CHIPINFO:
		    ...
		    if (err){
		        GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_READ_CHIPINFO  failed.");
		        return err;
		    }				 
		break;	  
	...
	case COMPAT_GSENSOR_IOCTL_READ_SENSORDATA:
		    ...
		    if (err){
		        GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_READ_SENSORDATA  failed.");
		        return err;
		    }
	...
	case COMPAT_GSENSOR_IOCTL_READ_GAIN:
		    ...
		    if (err){
		        GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_READ_GAIN  failed.");
		        return err;
		    }			 
		break;
	...
	case COMPAT_GSENSOR_IOCTL_READ_RAW_DATA:
		...
		if (err){
			GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_READ_RAW_DATA  failed.");
			return err;
		}
	...
	case COMPAT_GSENSOR_IOCTL_SET_CALI:
		...
		if (err){
			GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_SET_CALI  failed.");
			return err;
		}
	...
	case COMPAT_GSENSOR_IOCTL_CLR_CALI:
		...
		if (err){
			GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_CLR_CALI  failed.");
			return err;
		}
		break;
	...
	case COMPAT_GSENSOR_IOCTL_GET_CALI:
		    ...
		    if (err){
		        GSE_ERR("kxtj2_1009 COMPAT_GSENSOR_IOCTL_GET_CALI  failed.");
		        return err;
		    }		
		break;
...
static long kxtj2_1009_unlocked_ioctl(struct file *file, unsigned int cmd,unsigned long arg)
{
	...
	switch(cmd)
	{
		...
		case GSENSOR_IOCTL_READ_SENSORDATA:
           ...
           if((err = KXTJ2_1009_ReadData(client, raw_data))!=0)
           {		 
		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			{
				obj->cali_sw[KXTJ2_1009_AXIS_X] = sensor_data.x * obj->reso->sensitivity / GRAVITY_EARTH_1000;
				obj->cali_sw[KXTJ2_1009_AXIS_Y] = sensor_data.y * obj->reso->sensitivity / GRAVITY_EARTH_1000;
				obj->cali_sw[KXTJ2_1009_AXIS_Z]= sensor_data.z * obj->reso->sensitivity / GRAVITY_EARTH_1000;	

				obj->cali_sw[KXTJ2_1009_AXIS_X]=obj->cali_sw[KXTJ2_1009_AXIS_X]*obj->cvt.sign[KXTJ2_1009_AXIS_X];
				obj->cali_sw[KXTJ2_1009_AXIS_Y]=obj->cali_sw[KXTJ2_1009_AXIS_Y]*obj->cvt.sign[KXTJ2_1009_AXIS_Y];
				obj->cali_sw[KXTJ2_1009_AXIS_Z]=obj->cali_sw[KXTJ2_1009_AXIS_Z]*obj->cvt.sign[KXTJ2_1009_AXIS_Z];
...
#endif 
    #if 1
     kxtj2_config_proc = proc_create(GSENSOR_CONFIG_PROC_FILE, 0660, NULL, &kxtj2_upgrade_proc_fops);
     if( kxtj2_config_proc == NULL)
            GSE_ERR("%s: Kxtj2 create proc node fail \n", __func__);
    #endif
...
{
#if 0
	const char *name = "mediatek,kxtj3";
